        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">বিষয়</th>
              ...
              {hasPermission('সময়সূচী') && <th className="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">কার্যক্রম</th>}
            </tr>
          </thead>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-40 flex justify-center items-center">
          <div className="bg-white p-8 rounded-lg shadow-2xl w-full max-w-md m-4">
            ...
            <form onSubmit={isEditModalOpen ? handleUpdate : handleSubmit} className="space-y-4">
                ...
                <input type="text" name="subject" value={isEditModalOpen ? entryToEdit!.subject : newEntry.subject} onChange={handleInputChange} placeholder="বিষয়" className="w-full px-4 py-2 border rounded-lg" required />
