...
const Vouchers: React.FC<VouchersProps> = ({ expenses, addExpense, updateExpense, deleteExpense, hasPermission, madrasahName, madrasahAddress, currentUser }) => {
  ...
  const handlePrint = () => {
    const reportMonth = selectedMonth ? new Date(selectedMonth + '-02').toLocaleString('bn-BD', { month: 'long', year: 'numeric' }) : 'সকল সময়';
  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4 mb-6">
        <h2 className="text-2xl font-semibold text-text-primary">ব্যয় ব্যবস্থাপনা (ভাউচার)</h2>
        <div className="flex items-center space-x-2">
            ...
            {hasPermission('ব্যয় ব্যবস্থাপনা') && (
        ...
        <>
            <div className="bg-white p-4 rounded-lg shadow-md mb-6 no-print">
                ...
                <div className="w-full sm:w-auto">
                    <label htmlFor="filterMonth" className="block text-sm font-medium text-gray-700">মাস অনুযায়ী দেখুন</label>
                    <select
                    id="filterMonth"
                    value={selectedMonth}
            ...
            <div id="vouchers-print-area">
                <div className="hidden print:block text-center mb-6">
                    ...
                    <p className="text-lg font-medium">
                        {selectedMonth ? new Date(selectedMonth + '-02').toLocaleString('bn-BD', { month: 'long', year: 'numeric' }) : 'সকল সময়'}
                    </p>
                </div>
                ...
                <div className="bg-white shadow-md rounded-lg overflow-x-auto">
                    ...
                    <thead className="bg-gray-50">
                        ...
                        {hasPermission('ব্যয় ব্যবস্থাপনা') && <th scope="col" className="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider no-print">কার্যক্রম</th>}
                        </tr>
                    </thead>
                    ...
                    <tfoot className="bg-gray-100 font-bold">
                        <tr>
                            <td colSpan={hasPermission('ব্যয় ব্যবস্থাপনা') ? 5 : 4} className="px-6 py-3 text-right text-sm">সর্বমোট খরচ:</td>
                            <td className="px-6 py-3 text-right text-sm font-mono">৳{totalAmount.toLocaleString('bn-BD')}</td>
                            {hasPermission('ব্যয় ব্যবস্থাপনা') && <td className="no-print"></td>}
                        </tr>
                    </tfoot>
                    </table>
                </div>
