  ...
  const handleResponsibilitiesChange = (e: React.ChangeEvent<HTMLInputElement>, isEditing: boolean) => {
    ...
    stateSetter((prev: any) => {
        ...
        if (checked) {
            ...
            return { ...prev, responsibilities: prev.responsibilities.filter((r: Page) => r !== page) };
        }
    });
  };
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">বিষয়</th>
            ...
            <form onSubmit={handleSubmit}>
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <input type="text" name="subject" value={newTeacher.subject} onChange={handleInputChange} placeholder="বিষয়" className="w-full px-4 py-2 border rounded-lg" required />
                ...
                <hr/>
                <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">দায়িত্বসমূহ</label>
            ...
            <form onSubmit={handleUpdate}>
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <input type="text" name="subject" value={teacherToEdit.subject} onChange={handleEditInputChange} placeholder="বিষয়" className="w-full px-4 py-2 border rounded-lg" required />
