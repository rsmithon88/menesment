...
const Reports: React.FC<ReportsProps> = ({ data, classOptions }) => {
  ...
  const financialData = useMemo(() => {
    ...
    const expenseDetails = [...generalExpenses, ...salaryExpenses]
        .sort((a, b) => new Date((a as any).date || (a as any).paymentDate!).getTime() - new Date((b as any).date || (b as any).paymentDate!).getTime());
    ...
    <div className="space-y-8">
        <div className="bg-white rounded-lg shadow-md">
            ...
            <div id="financial-reports" className="p-6 space-y-8">
                <section>
                    <h4 className="font-semibold text-lg mb-2">আয়-ব্যয়ের সারাংশ</h4>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                         <table className="min-w-full divide-y divide-gray-200">
                            <tbody className="bg-white divide-y divide-gray-200">
                                ...
                                <tr><td className="px-4 py-2">অন্যান্য ব্যয়</td><td className="px-4 py-2 text-right font-mono text-red-600">৳{financialData.totalExpenses.toLocaleString('bn-BD')}</td></tr>
                                <tr className="font-bold bg-gray-50"><td className="px-4 py-2">মোট ব্যয়</td><td className="px-4 py-2 text-right font-mono text-red-700">৳{financialData.totalExpenditure.toLocaleString('bn-BD')}</td></tr>
                        ...
                        <div>
                            <h4 className="font-semibold text-lg mb-2 text-center">আয় বনাম ব্যয়</h4>
                            <BarChart data={[{ label: 'আয়', value: financialData.totalCollection }, { label: 'ব্যয়', value: financialData.totalExpenditure }]} color="#3b82f6" />
                        </div>
                    </div>
                </section>

                <section>
                    <h4 className="font-semibold text-lg mb-2 pt-4 border-t">বিস্তারিত আয়ের রিপোর্ট</h4>
                        ...
                        <table className="min-w-full divide-y divide-gray-200 text-sm">
                            ...
                            <tbody className="bg-white divide-y divide-gray-100">
                             ...
                             <tfoot className="bg-gray-50 font-bold">
                                <tr>
                                    <td colSpan={4} className="px-3 py-2 text-right">মোট আয়:</td>
                ...
                <section>
                    <h4 className="font-semibold text-lg mb-2 pt-4 border-t">বিস্তারিত ব্যয়ের রিপোর্ট</h4>
                    <div className="overflow-x-auto max-h-96">
                        <table className="min-w-full divide-y divide-gray-200 text-sm">
                            <thead className="bg-gray-50 sticky top-0">
                                <tr>
                            ...
                            <tbody className="bg-white divide-y divide-gray-100">
                                {financialData.expenseDetails.map((exp: any, index: number) => (
                                    <tr key={index}>
                             ...
                             <tfoot className="bg-gray-50 font-bold">
                                <tr>
                                    <td colSpan={3} className="px-3 py-2 text-right">মোট ব্যয়:</td>
