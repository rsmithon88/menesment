    ...
    <div>
      ...
      <div className="mb-6 bg-white p-4 rounded-lg shadow-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                <label htmlFor="classFilter" className="block text-sm font-medium text-gray-700">শ্রেণী অনুযায়ী</label>
            ...
            <div>
                <label htmlFor="examFilter" className="block text-sm font-medium text-gray-700">পরীক্ষা অনুযায়ী</label>
