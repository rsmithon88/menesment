        ...
        <div id="marksheet-print-area" className="p-6 bg-white border-2 border-gray-300">
            ...
            <table className="min-w-full divide-y divide-gray-300 border border-gray-300">
                <thead className="bg-gray-100">
                    <tr>
                        <th className="px-4 py-2 text-left font-semibold text-gray-700">বিষয়</th>
                ...
                {activeTab === 'fees' && (
                    <div>
                        <div className="grid grid-cols-3 gap-4 mb-4 text-center">
                            ...
                            <div className="p-3 bg-red-50 rounded-lg"><p className="text-sm text-red-800">মোট বকেয়া</p><p className="font-bold text-lg text-red-900">৳{feeSummary.totalPending.toLocaleString('bn-BD')}</p></div>
                        </div>
...
const StudentInfo: React.FC<StudentInfoProps> = ({ students, fees, attendance, results, exams, madrasahName, madrasahAddress, initialStudent, classOptions }) => {
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    if (!rollNumber || !selectedClass) {
        setSearchMessage('অনুগ্রহ করে রোল নম্বর এবং শ্রেণী উভয়ই পূরণ করুন।');
