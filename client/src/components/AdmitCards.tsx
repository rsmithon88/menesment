...
const AdmitCardManagerModal: React.FC<{ 
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const updatedCard = { ...admitCard, studentPhotoUrl: photoPreviewUrl };
                ...
                <table className="min-w-full divide-y divide-gray-200">
                                ...
                                <tr key={student.id}>
                                    ...
                                    <td className="px-6 py-4">
                                        <span className={`px-2 py-1 text-xs font-semibold rounded-full ${hasCard ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'}`}>
                                            {hasCard ? 'ইস্যু করা হয়েছে' : 'ইস্যু করা হয়নি'}
                                        </span>
                                    </td>
                 ...
                 {filteredStudents.length === 0 && (
                    <p className="p-4 text-center text-gray-500">
                        {filterClass ? 'এই শ্রেণীতে কোনো শিক্ষার্থী পাওয়া যায়নি।' : 'প্রবেশপত্র ইস্যু করতে অনুগ্রহ করে একটি শ্রেণী নির্বাচন করুন।'}
                    </p>
                )}
            </div>
