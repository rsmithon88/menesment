...
const SummaryCard: React.FC<{ title: string; amount: string; type: 'income' | 'expense' }> = ({ title, amount, type }) => {
    ...
    const categoryText = isIncome ? 'আয়' : 'ব্যয়';
...
const Dashboard: React.FC<DashboardProps> = ({ students, teachers, fees, expenses, teacherSalaries }) => {
  ...
  const studentStatusData = [
    { label: 'সক্রিয়', value: activeStudents, color: '#10b981' },
    { label: 'নিষ্ক্রিয়', value: inactiveStudents, color: '#ef4444' },
  ];
    ...
    <div className="space-y-6">
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mt-4">
          ...
          <StatCard title="নিষ্ক্রিয় শিক্ষার্থী" value={inactiveStudents.toLocaleString('bn-BD')} icon={UsersIcon} color="bg-yellow-500" />
        </div>
      </div>
      
      <div>
        <h2 className="text-xl font-semibold text-text-primary">আয়ের উৎস</h2>
      ...
      <div>
        <h2 className="text-xl font-semibold text-text-primary">ব্যয়ের খাত</h2>
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mt-4">
            {totalSalaryPaid > 0 && (
      ...
      <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-4">
          ...
          <div className="bg-white p-4 rounded-lg shadow">
            <h3 className="text-center font-semibold text-text-primary mb-2">সক্রিয় বনাম নিষ্ক্রিয় শিক্ষার্থী</h3>
