...
const TeacherDashboard: React.FC<TeacherDashboardProps> = ({ user, contextData, teacherAttendance, onAddAttendance, onAddLeave }) => {
  ...
  const attendanceStatus = useMemo(() => {
    ...
    if (hasAttendedToday) return { text: 'আজকের হাজিরা সম্পন্ন হয়েছে', disabled: true, bg: 'bg-green-600' };
    if (!canMarkAttendance) return { text: 'হাজিরার সময় শেষ', disabled: true, bg: 'bg-red-500' };
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-1 bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="w-full border-b pb-4 mb-4">
                ...
                <p className="text-xs text-center text-gray-400 mt-2">উপস্থিতির সময়: সকাল ৮:০০ - বিকাল ৪:০০</p>
            </div>
            ...
            {teacherDetails && (
                 <div className="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-text-secondary">
                        ...
                        <p><span className="font-semibold text-text-primary w-20 inline-block">বিষয়:</span> {teacherDetails.subject}</p>
                ...
                <table className="min-w-full">
                    <thead className="border-b-2 border-gray-200">
                        <tr>
                            ...
                            <th className="py-2 px-3 text-left text-xs font-medium text-gray-500 uppercase">বিষয়</th>
