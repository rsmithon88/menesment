      ...
      <div className="bg-white shadow-md rounded-lg overflow-hidden">
        <div className="p-4 bg-blue-50 border-l-4 border-blue-500">
          <p className="text-sm text-blue-800">
            এখান থেকে আপনি যেকোনো শিক্ষককে 'সুপার অ্যাডমিন' হিসেবে নির্ধারণ করতে পারেন। সুপার অ্যাডমিনরা 'সেটিংস' এবং 'অ্যাডমিন রোল' পেজ ছাড়া প্রায় সকল পেজ অ্যাক্সেস করতে পারবেন।
          </p>
        </div>
