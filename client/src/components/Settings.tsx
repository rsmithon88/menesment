...
const Settings: React.FC<SettingsProps> = ({ 
  ...
  const handleAdminSubmit = (e: React.FormEvent) => {
    ...
    setAdminDetails(prev => ({ ...prev, password: '' }));
  };
      ...
      <div className="p-6">
          ...
          <form onSubmit={handleSmsSubmit}>
            ...
            <div className="mt-6 pt-6 border-t">
                 ...
                 <div className="space-y-4">
                    ...
                    {testSmsStatus === 'success' && <p className="text-green-600">মেসেজ সফলভাবে পাঠানো হয়েছে।</p>}
        ...
        {activeTab === 'receipts' && (
          <form onSubmit={handleReceiptBookSubmit}>
            <div className="space-y-4">
              <p className="text-sm text-gray-600">প্রতিটি শ্রেণীর জন্য রশিদ বইয়ের নম্বর নির্ধারণ করুন। এই নম্বরটি ফি আদায়ের রশিদে ব্যবহৃত হবে।</p>
        ...
        {activeTab === 'signatures' && (
          <div>
            ...
            <p className="text-sm text-gray-600 mb-6">এখানে শ্রেণি শিক্ষক এবং মুহতামিমের স্বাক্ষর আপলোড করুন। এই স্বাক্ষরগুলো প্রবেশপত্রে স্বয়ংক্রিয়ভাবে ব্যবহৃত হবে।</p>
